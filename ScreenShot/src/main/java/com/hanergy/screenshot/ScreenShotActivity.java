package com.hanergy.screenshot;
...
public class ScreenShotActivity extends Activity {
    ...
    public static final int SCREEN_SHOT_RESULT_CODE = 0x601;
                ...
                if (resultCode == -1 && data != null) {
                    ...
                    shotter.startScreenShot(new Shotter.OnShotListener() {
                        ...
                        public void onFinish( String screenShotPath ) {
                            ...
                            intent.putExtra(SCREEN_SHOT_PATH, screenShotPath);
                            setResult(SCREEN_SHOT_RESULT_CODE, intent);
